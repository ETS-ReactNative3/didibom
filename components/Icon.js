...
const FontAwesomeExtra = require('../assets/font/argon.ttf');
const IconArgonExtra = createIconSetFromIcoMoon(argonConfig, 'ArgonExtra');
const IconFontAwesomeExtra = createIconSetFromIcoMoon(argonConfig, 'ArgonExtra');
  ...
  render() {
    ...
    if (name && family && this.state.fontLoaded) {
      if (family === 'ArgonExtra') {
        ...
        return <IconFontAwesomeExtra name={name} family={family} {...rest} />
      }
